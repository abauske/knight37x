...
public class RenderSpearTNT implements IItemRenderer {
	
	protected ModelSpearTNT model = new ModelSpearTNT();
	private static ResourceLocation texture = new ResourceLocation("lance:textures/models/modelSpearTNT.png");

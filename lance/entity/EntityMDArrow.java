...
public class EntityMDArrow extends EntityArrow {
	...
	public EntityMDArrow(World world, EntityLivingBase entityLivingBase, EntityLivingBase entityLivingBase2, float par4, float par5) {
		super(world, entityLivingBase, entityLivingBase2, par4, par5);
	}
	
	public EntityMDArrow(World world) {
		super(world);
	}
	
	public EntityMDArrow(World world, double par2, double par4, double par6) {
		super(world, par2, par4, par6);
	}

	public EntityMDArrow(World world, EntityLivingBase entityLivingBase, float par3) {

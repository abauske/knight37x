...
//	
//	public EntityBallista(World par1World) {
//		super(par1World);
//	}
//
//	public EntityBallista(World par1World, double par2, double par4, double par6) {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (int k1 = 0; k1 < list.size(); ++k1)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityBallista)
                        {

...
public class InventoryTroll implements IInventory
{
    /**
    ...
    public InventoryTroll(EntityTroll troll)
    {
        this.troll = troll;
    }
    ...
    public void decrementAnimations()
    {
        for (int i = 0; i < this.mainInventory.length; ++i)
        {
            if (this.mainInventory[i] != null)
            {
                this.mainInventory[i].updateAnimation(this.troll.worldObj, this.troll, i, this.currentItem == i);
            }
        }
        ...
        for (int i = 0; i < armorInventory.length; i++)
        {
            ...
            {
            	try {
            		armorInventory[i].getItem().onArmorTick(troll.worldObj, null, armorInventory[i]);
    ...
    public void damageArmor(float par1)
    {
        ...
        for (int i = 0; i < this.armorInventory.length; ++i)
        {
            ...
            {
                this.armorInventory[i].damageItem((int)par1, this.troll);
    ...
    public void dropAllItems()
    {
        ...
        for (i = 0; i < this.mainInventory.length; ++i)
        {
            if (this.mainInventory[i] != null)
            {
                this.troll.entityDropItem(this.mainInventory[i], 0);
                this.mainInventory[i] = null;
            }
        }
        ...
        for (i = 0; i < this.armorInventory.length; ++i)
        {
            if (this.armorInventory[i] != null)
            {
                this.troll.entityDropItem(this.armorInventory[i], 0);
                this.armorInventory[i] = null;
            }
        }
    }
     ...
     */
    public void copyInventory(InventoryTroll inv)
    {
        int i;

        for (i = 0; i < this.mainInventory.length; ++i)
        {
            this.mainInventory[i] = ItemStack.copyItemStack(inv.mainInventory[i]);
        }

        for (i = 0; i < this.armorInventory.length; ++i)
        {
            this.armorInventory[i] = ItemStack.copyItemStack(inv.armorInventory[i]);
        }

        this.currentItem = inv.currentItem;
    }
